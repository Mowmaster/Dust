...
public class CrystalOreGenRed implements IWorldGenerator
{
    @Override
    public void generate(Random random, int chunkX, int chunkZ, World world, IChunkProvider chunkGenerator, IChunkProvider chunkProvider)
    {
        switch (world.provider.getDimensionId())
        {
            ...
            case 0: //Overworld
                this.runGenerator(this.gen_BlockOreRed, world, random, chunkX, chunkZ, 32,1,256);/*veins per chunk, min height, max height*/
   ...
   // private WorldGenerator gen_BlockEndOreBlack;
    ...
    public CrystalOreGenRed()
    {
        this.gen_BlockOreRed = new WorldGenMinable(ModBlocks.RedCrystalOre.getDefaultState(), 16/* vein size */);
