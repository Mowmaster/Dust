...
//jjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjjj
        //Layer y Top Row
        worldIn.setBlockState(pos.add(-2,0,2),Blocks.AIR.getDefaultState());
        worldIn.setBlockState(pos.add(-1,0,2),Blocks.AIR.getDefaultState());
        worldIn.setBlockState(pos.add(0,0,2),Blocks.AIR.getDefaultState());
        worldIn.setBlockState(pos.add(1,0,2),Blocks.AIR.getDefaultState());
        worldIn.setBlockState(pos.add(2,0,2),Blocks.AIR.getDefaultState());
        //Layer y 2nd from Top Row
        worldIn.setBlockState(pos.add(-2,0,1),Blocks.AIR.getDefaultState());
        worldIn.setBlockState(pos.add(-1,0,1),Blocks.AIR.getDefaultState());
        worldIn.setBlockState(pos.add(0,0,1),Blocks.AIR.getDefaultState());
        worldIn.setBlockState(pos.add(1,0,1),Blocks.AIR.getDefaultState());
        worldIn.setBlockState(pos.add(2,0,1),Blocks.AIR.getDefaultState());
        //Layer y Middle Row
        worldIn.setBlockState(pos.add(-2,0,0),Blocks.AIR.getDefaultState());
        ...
        //Layer y Top Row
        worldIn.setBlockState(pos.add(-2,1,2),Blocks.AIR.getDefaultState());
        worldIn.setBlockState(pos.add(-1,1,2),Blocks.AIR.getDefaultState());
        worldIn.setBlockState(pos.add(0,1,2),Blocks.AIR.getDefaultState());
        worldIn.setBlockState(pos.add(1,1,2),Blocks.AIR.getDefaultState());
        worldIn.setBlockState(pos.add(2,1,2),Blocks.AIR.getDefaultState());
        //Layer y 2nd from Top Row
        worldIn.setBlockState(pos.add(-2,1,1),Blocks.AIR.getDefaultState());
        worldIn.setBlockState(pos.add(-1,1,1),Blocks.AIR.getDefaultState());
        worldIn.setBlockState(pos.add(0,1,1),Blocks.AIR.getDefaultState());
        worldIn.setBlockState(pos.add(1,1,1),Blocks.AIR.getDefaultState());
        worldIn.setBlockState(pos.add(2,1,1),Blocks.AIR.getDefaultState());
        //Layer y Middle Row
        worldIn.setBlockState(pos.add(-2,1,0),Blocks.AIR.getDefaultState());
        worldIn.setBlockState(pos.add(-1,1,0),Blocks.AIR.getDefaultState());
        ...
        //Layer y Top Row
        worldIn.setBlockState(pos.add(-2,2,2),Blocks.AIR.getDefaultState());
        worldIn.setBlockState(pos.add(-1,2,2),Blocks.AIR.getDefaultState());
        worldIn.setBlockState(pos.add(0,2,2),Blocks.AIR.getDefaultState());
        worldIn.setBlockState(pos.add(1,2,2),Blocks.AIR.getDefaultState());
        worldIn.setBlockState(pos.add(2,2,2),Blocks.AIR.getDefaultState());
        //Layer y 2nd from Top Row
        worldIn.setBlockState(pos.add(-2,2,1),Blocks.AIR.getDefaultState());
        worldIn.setBlockState(pos.add(-1,2,1),Blocks.AIR.getDefaultState());
        worldIn.setBlockState(pos.add(0,2,1),Blocks.AIR.getDefaultState());
        worldIn.setBlockState(pos.add(1,2,1),Blocks.AIR.getDefaultState());
        worldIn.setBlockState(pos.add(2,2,1),Blocks.AIR.getDefaultState());
        //Layer y Middle Row
        worldIn.setBlockState(pos.add(-2,2,0),Blocks.AIR.getDefaultState());
        worldIn.setBlockState(pos.add(-1,2,0),Blocks.AIR.getDefaultState());
