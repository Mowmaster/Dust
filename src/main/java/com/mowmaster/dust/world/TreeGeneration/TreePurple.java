...
public class TreePurple extends WorldGenAbstractTree
{
    ...
    private final IBlockState logBlock = BlockDustLog.logpurple.getDefaultState();
    private final IBlockState leafBlock = BlockDustLeaf.leaf.getDefaultState().withProperty(LEAVES, CrystalBlocks.CrystalLeaves.PURPLE);
