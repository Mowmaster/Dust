 ...
 */
public class TreePurple extends WorldGenAbstractTree
{
    private final int minTreeHeight = 4;

    private final IBlockState logBlock = BlockRegistry.logpurple.getDefaultState();
    private final IBlockState leafBlock = BlockRegistry.leaf.getDefaultState().withProperty(LEAVES, CrystalBlocks.CrystalLeaves.PURPLE);
    ...
    public TreePurple(boolean par1){
        super(par1);
    }
}
