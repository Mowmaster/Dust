 ...
 */
public class TreeYellow extends WorldGenAbstractTree
{
    private final int minTreeHeight = 4;

    private final IBlockState logBlock = BlockRegistry.logyellow.getDefaultState();
    private final IBlockState leafBlock = BlockRegistry.leaf.getDefaultState().withProperty(LEAVES, CrystalBlocks.CrystalLeaves.YELLOW);
    ...
    public TreeYellow(boolean par1){
        super(par1);
    }
}
