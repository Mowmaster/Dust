...
public class TreeYellow extends WorldGenAbstractTree
{
    ...
    private final IBlockState logBlock = BlockDustLog.logyellow.getDefaultState();
    private final IBlockState leafBlock = BlockDustLeaf.leaf.getDefaultState().withProperty(LEAVES, CrystalBlocks.CrystalLeaves.YELLOW);
