 ...
 */
public class TreeOrange extends WorldGenAbstractTree
{
    private final int minTreeHeight = 4;

    private final IBlockState logBlock = BlockRegistry.logorange.getDefaultState();
    private final IBlockState leafBlock = BlockRegistry.leaf.getDefaultState().withProperty(LEAVES, CrystalBlocks.CrystalLeaves.ORANGE);
    ...
    public TreeOrange(boolean par1){
        super(par1);
    }
}
