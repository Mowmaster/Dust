...
public class TreeOrange extends WorldGenAbstractTree
{
    ...
    private final IBlockState logBlock = BlockDustLog.logorange.getDefaultState();
    private final IBlockState leafBlock = BlockDustLeaf.leaf.getDefaultState().withProperty(LEAVES, CrystalBlocks.CrystalLeaves.ORANGE);
