...
public class TreeBlue extends WorldGenAbstractTree
{
    ...
    private final IBlockState logBlock = BlockRegistry.logblue.getDefaultState();
    private final IBlockState leafBlock = BlockRegistry.leaf.getDefaultState().withProperty(LEAVES, CrystalBlocks.CrystalLeaves.BLUE);
