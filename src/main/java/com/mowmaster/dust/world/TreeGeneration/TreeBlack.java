...
public class TreeBlack extends WorldGenAbstractTree
{
    ...
    private final IBlockState logBlock = BlockDustLog.logblack.getDefaultState();
    private final IBlockState leafBlock = BlockDustLeaf.leaf.getDefaultState().withProperty(LEAVES, CrystalBlocks.CrystalLeaves.BLACK);
