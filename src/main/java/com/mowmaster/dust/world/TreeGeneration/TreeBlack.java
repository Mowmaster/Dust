...
public class TreeBlack extends WorldGenAbstractTree
{
    ...
    private final IBlockState logBlock = BlockRegistry.logblack.getDefaultState();
    private final IBlockState leafBlock = BlockRegistry.leaf.getDefaultState().withProperty(LEAVES, CrystalBlocks.CrystalLeaves.BLACK);
