...
public class ChaosOrbEntity extends baseOrbEntity {
    ...
    public void playerTouch(Player player) {
        ...
        int modifiedAmount = Math.round(orbValue * getAffinityMultiplier(serverPlayer,ElementEnum.CHAOS));
        DustElementAttachmentHelper.addToElement(serverPlayer, ElementEnum.CHAOS, modifiedAmount);
