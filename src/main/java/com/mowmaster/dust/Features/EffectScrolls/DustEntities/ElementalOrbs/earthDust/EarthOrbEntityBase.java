...
public class EarthOrbEntityBase extends ElementalOrbEntityBase {
    ...
    public void playerTouch(Player player) {
        ...
        int added = DustElementAttachmentHelper.addToElementEarth(serverPlayer, modifiedAmount, true);
        if(added>0)
        {
            actuallyAdded = DustElementAttachmentHelper.addToElementEarth(serverPlayer, modifiedAmount, false);
            System.out.println("Added By EarthOrb: " + actuallyAdded);
            this.discard();
        }
    }
}