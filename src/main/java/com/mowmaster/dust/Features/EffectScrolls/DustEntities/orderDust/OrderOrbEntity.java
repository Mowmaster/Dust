...
public class OrderOrbEntity extends baseOrbEntity {
    ...
    public void playerTouch(Player player) {
        ...
        int modifiedAmount = Math.round(orbValue * getAffinityMultiplier(serverPlayer,ElementEnum.ORDER));
        DustElementAttachmentHelper.addToElement(serverPlayer, ElementEnum.ORDER, modifiedAmount);
