package com.mowmaster.dust.Features.DustEntities.chaosDust;
...
public class ChaosOrbRenderer extends EntityRenderer<baseOrbEntity, baseOrbRenderState> {
    ...
    public ChaosOrbRenderer(EntityRendererProvider.Context context) {
        super(context);
