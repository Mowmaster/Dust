...
public class DDFoodProperties
{
    ...
    public static final Consumable CORNBREAD_EDIBLE = Consumables.defaultFood().onConsume(
            new ApplyStatusEffectsConsumeEffect( new MobEffectInstance(MobEffects.SATURATION,1, 5), 0.45f)).build();
}
