...
public class BlockOreRed extends Block {
...
// float resistance = anti creeper damage (explosion proofness)
    public BlockOreRed(String unlocalizedName, Material material, float hardness, float resistance, float lightlevel, Item drop, int meta, int least, int most)
    {
        super(material);
...
// , Item drop, int meta, int least, int most
    public BlockOreRed(String unlocalizedName, float hardness, float resistance, float lightlevel, Item drop, int meta, int least, int most)
    // , drop, meta, least, most
    {
        this(unlocalizedName, Material.rock, hardness, resistance, lightlevel, drop, meta, least, most);
    }

    public BlockOreRed(String unlocalizedName)
