...
public class BlockOreBlue extends Block {
...
// float resistance = anti creeper damage (explosion proofness)
    public BlockOreBlue(String unlocalizedName, Material material, float hardness, float resistance, float lightlevel, Item drop, int meta, int least, int most)
    {
        super(material);
    ...
    */
    ...
    public BlockOreBlue(String unlocalizedName, float hardness, float resistance, float lightlevel, Item drop, int meta, int least, int most)
    // , drop, meta, least, most
    {
        this(unlocalizedName, Material.rock, hardness, resistance, lightlevel, drop, meta, least, most);
    }

    public BlockOreBlue(String unlocalizedName)
    // , ModItems.ItemCrystalRed, 0, 1, 3
    {
        this(unlocalizedName, 10.0f, 5.0f, 0.3f, ModItems.ItemCrystalBlue, 0, 1, 1);
    }
