...
public class BlockOreYellow extends Block {
...
// float resistance = anti creeper damage (explosion proofness)
    public BlockOreYellow(String unlocalizedName, Material material, float hardness, float resistance, float lightlevel, Item drop, int meta, int least, int most)
    {
        super(material);
    ...
    */
    ...
    public BlockOreYellow(String unlocalizedName, float hardness, float resistance, float lightlevel, Item drop, int meta, int least, int most)
    // , drop, meta, least, most
    {
        this(unlocalizedName, Material.rock, hardness, resistance, lightlevel, drop, meta, least, most);
    }

    public BlockOreYellow(String unlocalizedName)
