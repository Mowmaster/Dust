...
public class BlockNetherOreYellow extends Block {
...
// float resistance = anti creeper damage (explosion proofness)
    public BlockNetherOreYellow(String unlocalizedName, Material material, float hardness, float resistance, float lightlevel, Item drop, int meta, int least, int most)
    {
        super(material);
    ...
    */
    ...
    public BlockNetherOreYellow(String unlocalizedName, float hardness, float resistance, float lightlevel, Item drop, int meta, int least, int most)
    // , drop, meta, least, most
    {
        this(unlocalizedName, Material.rock, hardness, resistance, lightlevel, drop, meta, least, most);
    }

    public BlockNetherOreYellow(String unlocalizedName)
    // , ModItems.ItemCrystalRed, 0, 1, 3
    {
        this(unlocalizedName, 10.0f, 5.0f, 1.0f, ModItems.ItemCrystalYellow, 0, 1, 1);
    }
