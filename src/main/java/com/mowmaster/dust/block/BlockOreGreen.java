...
public class BlockOreGreen extends Block {
...
// float resistance = anti creeper damage (explosion proofness)
    public BlockOreGreen(String unlocalizedName, Material material, float hardness, float resistance, float lightlevel, Item drop, int meta, int least, int most)
    {
        super(material);
    ...
    */
    ...
    public BlockOreGreen(String unlocalizedName, float hardness, float resistance, float lightlevel, Item drop, int meta, int least, int most)
    // , drop, meta, least, most
    {
        this(unlocalizedName, Material.rock, hardness, resistance, lightlevel, drop, meta, least, most);
    }

    public BlockOreGreen(String unlocalizedName)
    // , ModItems.ItemCrystalRed, 0, 1, 3
    {
        this(unlocalizedName, 20.0f, 10.0f, 0.5f, ModItems.ItemCrystalGreen, 0, 1, 1);
    }
