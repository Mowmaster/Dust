...
public class BlockEndOreBlack extends Block {
...
// float resistance = anti creeper damage (explosion proofness)
    public BlockEndOreBlack(String unlocalizedName, Material material, float hardness, float resistance, float lightlevel, Item drop, int meta, int least, int most)
    {
        super(material);
    ...
    */
    ...
    public BlockEndOreBlack(String unlocalizedName, float hardness, float resistance, float lightlevel, Item drop, int meta, int least, int most)
    // , drop, meta, least, most
    {
        this(unlocalizedName, Material.rock, hardness, resistance, lightlevel, drop, meta, least, most);
    }

    public BlockEndOreBlack(String unlocalizedName)
    // , ModItems.ItemCrystalRed, 0, 1, 3
    {
        // 50 and 2000 are obsidian level
        this(unlocalizedName, 50.0f, 2000.0f, 0.0f, ModItems.ItemCrystalBlack, 0, 1, 1);
    }
