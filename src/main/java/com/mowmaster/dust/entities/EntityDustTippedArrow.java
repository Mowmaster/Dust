...
/**
 * Created by KingMowmaster on 2/1/2020.
 */

public class EntityDustTippedArrow extends EntityArrow {

    private static final DataParameter<Integer> COLOR = EntityDataManager.<Integer>createKey(EntityDustTippedArrow.class, DataSerializers.VARINT);
    private PotionType potion = PotionTypes.EMPTY;
    private final Set<PotionEffect> customPotionEffects = Sets.<PotionEffect>newHashSet();
    private boolean fixedColor;

    public EntityDustTippedArrow(World worldIn)
    {
        super(worldIn);
    }

    public EntityDustTippedArrow(World worldIn, double x, double y, double z)
    {
        super(worldIn, x, y, z);
    }

    public EntityDustTippedArrow(World worldIn, EntityLivingBase shooter)
    {
    ...
    {
        if (stack.getItem() == ItemRegistry.dustTippedArrow)
        {
    ...
    protected ItemStack getArrowStack()
    {
        ...
        {
            ItemStack itemstack = new ItemStack(ItemRegistry.dustTippedArrow);
