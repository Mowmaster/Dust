...
public class RenderCluster extends TileEntityRenderer<TileCrystalCluster> {

    public RenderCluster(TileEntityRendererDispatcher rendererDispatcher)
    {
        super(rendererDispatcher);
    }

    @Override
    public void render(@Nonnull TileCrystalCluster tileEntityIn, float partialTicks, MatrixStack matrixStackIn, IRenderTypeBuffer bufferIn, int combinedLightIn, int combinedOverlayIn) {
    ...
    {
        ClientRegistry.bindTileEntityRenderer(TileCrystalCluster.CLUSTERTYPE, RenderCluster::new);
    }
}