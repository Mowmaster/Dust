...
public class TileTierZeroFurnace extends TileEntityBase implements ITickable, IItemHandler
{
    ...
    public NBTTagCompound writeToNBT(NBTTagCompound compound)
    {
        ...
        compound.setTag("tierzerofurnace",this.tierZeroFurnace.serializeNBT());
    ...
    public void readFromNBT(NBTTagCompound compound) {
        ...
        this.tierZeroFurnace.deserializeNBT(compound.getCompoundTag("tierzerofurnace"));
