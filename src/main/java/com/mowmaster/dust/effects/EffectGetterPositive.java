...
public class EffectGetterPositive
{
    private static final EffectGetterPositive EFFECT_BASE = new EffectGetterPositive();
    private final Map<Integer, EffectHashMapPositive> effectList = Maps.<Integer, EffectHashMapPositive>newHashMap();
    public static EffectGetterPositive instance()
    {
        return EFFECT_BASE;
    }


    private EffectGetterPositive()
    {
        ...
        this.addPositiveEffect(1050000050, new PotionEffect(PotionRegistry.POTION_TILLER));
        ...
        this.addPositiveEffect(1000050050, new PotionEffect(MobEffects.SATURATION));//
        ...
        this.addPositiveEffect(1050050000, new PotionEffect(MobEffects.WATER_BREATHING));//
    ...
    public void addPositiveEffect(int colorIn, PotionEffect effectOut)
    {
        ...
        {
            this.effectList.put(colorIn,new EffectHashMapPositive(colorIn,effectOut));;
        }
        else return;
    }
    ...
    {
        for (Map.Entry<Integer, EffectHashMapPositive> entry : this.effectList.entrySet())
        {
