...
{
    public static final Potion POTION_MAGNETISM = new PotionMagnetism("effect.magnetism","potionmagnetism",false,13382553,0,0);
    public static final Potion POTION_TILLER = new PotionBasic("effect.tiller","potiontiller",false,11898433,11,0);
    public static final Potion POTION_HARVESTER = new PotionBasic("effect.harvester","potionharvester",false,3368652,9,0);
    public static final Potion POTION_GROWER = new PotionBasic("effect.grower","potiongrower",false,3394560,10,0);
