...
public class ParticleCreator extends Particle
{
    public static final ResourceLocation TEXTURE = new ResourceLocation(Reference.MODID, "particles/white_dot");

    private final float desiredScale;
    private final boolean fade;

    public ParticleCreator(World world, double posX, double posY, double posZ, double motionX, double motionY, double motionZ, int color, float scale, int maxAge, float gravity, boolean collision, boolean fade) {
