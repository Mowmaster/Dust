...
public class ItemColorCrystal extends Item {
    public ItemColorCrystal(Properties builder) {
        super(builder.group(dust.ITEM_GROUP));
    }

    public static void handleItemColors(ColorHandlerEvent.Item event) {
        event.getItemColors().register((itemstack, tintIndex) -> {if (tintIndex == 1){return getColorFromNBT(itemstack);} else {return -1;}},CRYSTAL);
    ...
    public static final Item CRYSTAL = new ItemColorCrystal(new Properties().group(ItemGroup.MATERIALS)).setRegistryName(new ResourceLocation(MODID, "itemcrystal"));
