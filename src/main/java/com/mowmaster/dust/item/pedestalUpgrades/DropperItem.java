...
*/
    ...
    {
        event.getRegistry().register(new DropperItem(new Item.Properties().maxStackSize(1).group(dust.itemGroup)).setRegistryName(new ResourceLocation(MODID, "upgrade_dropperitem")));
    }
