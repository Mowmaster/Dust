...
public class CrystalShovelBlack extends ItemSpade {

    public CrystalShovelBlack(ToolMaterial material){

        super(material);

    }

    public CrystalShovelBlack(String crystalshovel_black, ToolMaterial material){
        super(material);
        this.setUnlocalizedName(crystalshovel_black);
    }
