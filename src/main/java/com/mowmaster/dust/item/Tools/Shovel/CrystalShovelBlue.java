...
public class CrystalShovelBlue extends ItemSpade {

    public CrystalShovelBlue(ToolMaterial material){
    ...
    public CrystalShovelBlue(String crystalshovel_blue, ToolMaterial material){
        super(material);
        this.setUnlocalizedName(crystalshovel_blue);
