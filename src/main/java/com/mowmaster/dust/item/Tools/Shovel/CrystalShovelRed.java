...
public class CrystalShovelRed extends ItemSpade {

    public CrystalShovelRed(ToolMaterial material){
    ...
    public CrystalShovelRed(String crystalshovel_red, ToolMaterial material){
        super(material);
        this.setUnlocalizedName(crystalshovel_red);
