...
public class CrystalShovelOrange extends ItemSpade {

    public CrystalShovelOrange(ToolMaterial material){

        super(material);

    }

    public CrystalShovelOrange(String crystalshovel_orange, ToolMaterial material){
        super(material);
        this.setUnlocalizedName(crystalshovel_orange);
    }
