...
public class CrystalShovelPurple extends ItemSpade {

    public CrystalShovelPurple(ToolMaterial material){

        super(material);

    }

    public CrystalShovelPurple(String crystalshovel_purple, ToolMaterial material){
        super(material);
        this.setUnlocalizedName(crystalshovel_purple);
    }
