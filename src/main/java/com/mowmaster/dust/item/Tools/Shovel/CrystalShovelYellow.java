...
public class CrystalShovelYellow extends ItemSpade {

    public CrystalShovelYellow(ToolMaterial material){

        super(material);

    }

    public CrystalShovelYellow(String crystalshovel_yellow, ToolMaterial material){
        super(material);
        this.setUnlocalizedName(crystalshovel_yellow);
    }
