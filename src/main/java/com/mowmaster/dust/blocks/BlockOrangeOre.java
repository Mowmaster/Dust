...
public class BlockOrangeOre extends BlockDirectional implements IMetaBlockName
{
    ...
    public BlockOrangeOre(String unloc)
    {
        ...
        this.setDefaultState(this.blockState.getBaseState().withProperty(ORANGESTATE, CrystalBlocks.CrystalOres.ORE).withProperty(FACING, EnumFacing.UP));
    }

    @Override
    protected BlockStateContainer createBlockState()
    {
        return new BlockStateContainer(this,new IProperty[]{ORANGESTATE,FACING});
    }
