...
public class BlockWhiteOre extends BlockDirectional implements IMetaBlockName
{
    //the string text is what you use in your json file
    public static final PropertyEnum WHITESTATE = PropertyEnum.create("whitestate",CrystalBlocks.CrystalOres.class);



    public BlockWhiteOre(String unloc)
    {
        super(Material.ROCK);
        this.setUnlocalizedName(unloc);
        this.setRegistryName(new ResourceLocation(Reference.MODID, unloc));
        this.setDefaultState(this.blockState.getBaseState().withProperty(WHITESTATE, CrystalBlocks.CrystalOres.ORE).withProperty(FACING, EnumFacing.UP));
    }

    @Override
    protected BlockStateContainer createBlockState()
    {
        return new BlockStateContainer(this,new IProperty[]{WHITESTATE,FACING});
    }
    ...
    {
        CrystalBlocks.CrystalOres ores = (CrystalBlocks.CrystalOres) state.getValue(WHITESTATE);
        return ores.getID();
    }
    ...
    public IBlockState getStateFromMeta(int meta)
    {
        ...
        return this.getDefaultState().withProperty(WHITESTATE,CrystalBlocks.CrystalOres.values()[meta]);
    }
    ...
    public BlockRenderLayer getBlockLayer(IBlockState state) {
        switch((CrystalBlocks.CrystalOres)state.getValue(WHITESTATE))
        {
            case FIFTH:
            case FOURTH:
            case THIRD:
