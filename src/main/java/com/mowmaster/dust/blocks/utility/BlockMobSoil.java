...
public class BlockMobSoil extends BlockBasic
{
    public static Block darksoil;
    public BlockMobSoil(String unloc, String registryName)
    {
    ...
    public static boolean spawnMobs(Entity mob) {
        ...
        if (mob.isBeingRidden()) {
            mob.getPassengers().forEach(BlockMobSoil::spawnMobs);
        }
        return true;
    }
    ...
    {
        darksoil = new BlockMobSoil("darksoil","darksoil");
    }
