...
public class CrystalCrusherBasic extends BlockBasic implements ITileEntityProvider
{
    ...
    public CrystalCrusherBasic(String unloc, String registryName)
    {
        super(Material.ROCK);
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        if(!worldIn.isRemote) {
            ...
            if (tileEntity instanceof TileCrystalCrusherBasic) {
                TileCrystalCrusherBasic tileCrusher = (TileCrystalCrusherBasic) tileEntity;
    ...
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        return new TileCrystalCrusherBasic();
    }
    ...
    {
        crystalcrusher = new CrystalCrusherBasic("crystalcrusherbasic","crystalcrusherbasic");
    }
