...
import com.mowmaster.dust.tiles.TileTierZeroFurnace;
...
public class TierZeroFurnace extends BlockBasic implements ITileEntityProvider
{

    public static Block tierZeroFurnace;
    private static AxisAlignedBB bounds = new AxisAlignedBB(0.125D, 0.0D, 0.125D, 0.875D, 0.5D, 0.875D);

    public TierZeroFurnace(String unloc, String registryName)
    {
        super(Material.ROCK);
    ...
    public Item getItemDropped(IBlockState state, Random rand, int fortune) {
        return Item.getItemFromBlock(tierZeroFurnace);
    }
    ...
    public boolean onBlockActivated(World worldIn, BlockPos pos, IBlockState state, EntityPlayer playerIn, EnumHand hand, EnumFacing facing, float hitX, float hitY, float hitZ) {
        if(!worldIn.isRemote) {
            ...
            if (tileEntity instanceof TileTierZeroFurnace) {
                TileTierZeroFurnace tileFurnace = (TileTierZeroFurnace) tileEntity;
    ...
    public TileEntity createNewTileEntity(World worldIn, int meta) {
        return new TileTierZeroFurnace();
    }
    ...
    {
        tierZeroFurnace = new TierZeroFurnace("tierzerofurnace","tierzerofurnace");
    }

    public static void Register()
    {
        registerBlock(tierZeroFurnace);
    }

    public static void RegisterRender()
    {
        registerRender(tierZeroFurnace);
    }
}
