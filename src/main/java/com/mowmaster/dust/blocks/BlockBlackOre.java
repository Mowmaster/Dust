...
public class BlockBlackOre extends Block implements IMetaBlockName
{
    ...
    public BlockBlackOre(String unloc)
    {
        ...
        this.setDefaultState(this.blockState.getBaseState().withProperty(BLACKSTATE, CrystalBlocks.CrystalOres.ORE));
    }

    @Override
    protected BlockStateContainer createBlockState()
    {
        return new BlockStateContainer(this,new IProperty[]{BLACKSTATE});
    }

    @Override
    public int getMetaFromState(IBlockState state)
    {
        CrystalBlocks.CrystalOres ores = (CrystalBlocks.CrystalOres) state.getValue(BLACKSTATE);
        return ores.getID();
    }
    ...
    {
        return this.getDefaultState().withProperty(BLACKSTATE, CrystalBlocks.CrystalOres.values()[meta]);
    }
    ...
    public AxisAlignedBB getBoundingBox(IBlockState state, IBlockAccess source, BlockPos pos)
    {
        ...
        switch ((CrystalBlocks.CrystalOres)state.getValue(BLACKSTATE))
        {
            case FIFTH:
            case FOURTH:
            case THIRD:
