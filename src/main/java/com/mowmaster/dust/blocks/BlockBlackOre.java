...
public class BlockBlackOre extends BlockDirectional implements IMetaBlockName
{
    ...
    public BlockBlackOre(String unloc)
    {
        ...
        this.setDefaultState(this.blockState.getBaseState().withProperty(BLACKSTATE, CrystalBlocks.CrystalOres.ORE).withProperty(FACING, EnumFacing.UP));
    }

    @Override
    protected BlockStateContainer createBlockState()
    {
        return new BlockStateContainer(this,new IProperty[]{BLACKSTATE,FACING});
    }
