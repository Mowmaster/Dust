...
public class BlockPurpleOre extends Block implements IMetaBlockName
{
    ...
    public BlockPurpleOre(String unloc)
    {
        ...
        this.setDefaultState(this.blockState.getBaseState().withProperty(PURPLESTATE, CrystalBlocks.CrystalOres.ORE));
    }

    @Override
    protected BlockStateContainer createBlockState()
    {
        return new BlockStateContainer(this,new IProperty[]{PURPLESTATE});
    }
