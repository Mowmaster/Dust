...
public class BlockGreenOre extends BlockDirectional implements IMetaBlockName
{
    //the string text is what you use in your json file
    public static final PropertyEnum GREENSTATE = PropertyEnum.create("greenstate",CrystalBlocks.CrystalOres.class);



    public BlockGreenOre(String unloc)
    {
        super(Material.ROCK);
        this.setUnlocalizedName(unloc);
        this.setRegistryName(new ResourceLocation(Reference.MODID, unloc));
        this.setDefaultState(this.blockState.getBaseState().withProperty(GREENSTATE, CrystalBlocks.CrystalOres.ORE).withProperty(FACING, EnumFacing.UP));
    }

    @Override
    protected BlockStateContainer createBlockState()
    {
        return new BlockStateContainer(this,new IProperty[]{GREENSTATE,FACING});
    }
    ...
    {
        CrystalBlocks.CrystalOres ores = (CrystalBlocks.CrystalOres) state.getValue(GREENSTATE);
        return ores.getID();
    }
    ...
    public IBlockState getStateFromMeta(int meta)
    {
        ...
        return this.getDefaultState().withProperty(GREENSTATE,CrystalBlocks.CrystalOres.values()[meta]);
    }
    ...
    public BlockRenderLayer getBlockLayer(IBlockState state) {
        switch((CrystalBlocks.CrystalOres)state.getValue(GREENSTATE))
        {
            case FIFTH:
            case FOURTH:
            case THIRD:
