...
public class BlockBlueOre extends BlockDirectional implements IMetaBlockName
{
    //the string text is what you use in your json file
    public static final PropertyEnum BLUESTATE = PropertyEnum.create("state",CrystalBlocks.CrystalOres.class);



    public BlockBlueOre(String unloc)
    {
        super(Material.ROCK);
        this.setUnlocalizedName(unloc);
        this.setRegistryName(new ResourceLocation(Reference.MODID, unloc));
        this.setDefaultState(this.blockState.getBaseState().withProperty(BLUESTATE, CrystalBlocks.CrystalOres.ORE).withProperty(FACING, EnumFacing.UP));
    }

    @Override
    protected BlockStateContainer createBlockState()
    {
        return new BlockStateContainer(this,new IProperty[]{BLUESTATE,FACING});
    }
    ...
    {
        CrystalBlocks.CrystalOres ores = (CrystalBlocks.CrystalOres) state.getValue(BLUESTATE);
        return ores.getID();
    }
    ...
    {
        return this.getDefaultState().withProperty(BLUESTATE,CrystalBlocks.CrystalOres.values()[meta]);
    }
...
/*
    @Override
    public int getMetaFromState(IBlockState state) {
        CrystalBlocks.CrystalOres redstate = (CrystalBlocks.CrystalOres) state.getValue(BLUESTATE);
...
*/
    ...
    public IBlockState getStateFromMeta(int meta) {
        ...
        return this.getDefaultState().withProperty(BLUESTATE,redstate).withProperty(FACING, facing); //Returns the correct state
    }
*/
    /**
    ...
    public BlockRenderLayer getBlockLayer(IBlockState state) {
        switch((CrystalBlocks.CrystalOres)state.getValue(BLUESTATE))
        {
            case FIFTH:
            case FOURTH:
            case THIRD:
