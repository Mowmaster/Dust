...
public class BlockBlueOre extends Block implements IMetaBlockName
{
    ...
    public BlockBlueOre(String unloc)
    {
        ...
        this.setDefaultState(this.blockState.getBaseState().withProperty(BLUESTATE, CrystalBlocks.CrystalOres.ORE));
    }

    @Override
    protected BlockStateContainer createBlockState()
    {
        return new BlockStateContainer(this,new IProperty[]{BLUESTATE});
    }
