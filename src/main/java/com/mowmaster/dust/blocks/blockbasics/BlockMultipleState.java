package com.mowmaster.dust.blocks.blockbasics;
...
public class BlockMultipleState // extends BlockDirectional implements IMetaBlockName
{
    /*
    ...
    public BlockMultipleState(String unloc)
    {
        super(Material.ROCK);
