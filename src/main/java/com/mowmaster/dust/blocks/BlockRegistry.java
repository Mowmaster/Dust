...
public class BlockRegistry
{
    ...
    public static void init() {
        ...
        ancientstone4 = new BlockBasic("ancientstone4", "ancient/ancientstone4", Material.ROCK, SoundType.STONE, 20, 10, 10);
        ancientstonebricks2 = new BlockBasic("ancientstonebricks2", "ancient/ancientstonebricks2", Material.ROCK, SoundType.STONE, 20, 10, 10);
...
public class BlockRegistry
{
    ...
    public static void init() {
        ...
        leafred = new BlockLeaf("leaves_red","leaves_red");
        leafblue = new BlockLeaf("leaves_blue","leaves_blue");
        leafyellow = new BlockLeaf("leaves_yellow","leaves_yellow");
        leafpurple = new BlockLeaf("leaves_purple","leaves_purple");
        leaforange = new BlockLeaf("leaves_orange","leaves_orange");
        leafgreen = new BlockLeaf("leaves_green","leaves_green");
        leafwhite = new BlockLeaf("leaves_white","leaves_white");
        leafblack = new BlockLeaf("leaves_black","leaves_black");
    ...
    public static void register()
    {
        ...
        registerBlock(leafred);
        registerBlock(leafblue);
        registerBlock(leafyellow);
        registerBlock(leafpurple);
        registerBlock(leaforange);
        registerBlock(leafgreen);
        registerBlock(leafwhite);
        registerBlock(leafblack);
    ...
    public static void registerRenders()
    {
        ...
        registerRenderLeaf(leafred);
        registerRenderLeaf(leafblue);
        registerRenderLeaf(leafyellow);
        registerRenderLeaf(leafpurple);
        registerRenderLeaf(leaforange);
        registerRenderLeaf(leafgreen);
        registerRenderLeaf(leafwhite);
        registerRenderLeaf(leafblack);
    ...
    //Special Package for Ancient Item Renders
    public static void registerRenderLeaf(Block block)
    {
        //ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation(new ResourceLocation(Reference.MODID, block.getUnlocalizedName().substring(5),"inventory")));
        ModelLoader.setCustomModelResourceLocation(Item.getItemFromBlock(block), 0, new ModelResourceLocation(new ResourceLocation(Reference.MODID,"leaves/" + block.getUnlocalizedName().substring(5)), "inventory"));
    }
