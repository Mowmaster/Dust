...
import com.mowmaster.dust.tiles.TileTest;
...
public class BlockTest extends DirectionalBlock {
    ...
    public BlockTest(Properties builder)
    {
        super(builder);
    ...
    private static final ResourceLocation RESLOC_TEST = new ResourceLocation(MODID, "pedestal/test");

    public static final Block BLOCK_TEST = new BlockTest(Properties.create(Material.ROCK, MaterialColor.STONE).hardnessAndResistance(2.0F, 10.0F).sound(SoundType.STONE)).setRegistryName(RESLOC_TEST);

    public static final Item ITEM_TEST = new BlockItem(BLOCK_TEST, new Item.Properties().group(dust.itemGroup)) {}.setRegistryName(RESLOC_TEST);
    ...
    {
        event.getRegistry().register(BLOCK_TEST);
    }
