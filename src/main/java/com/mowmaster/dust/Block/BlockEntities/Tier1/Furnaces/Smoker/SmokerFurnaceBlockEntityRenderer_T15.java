...
public class SmokerFurnaceBlockEntityRenderer_T15 implements BlockEntityRenderer<SmokerFurnaceBlockEntity_T15>
{
    ...
    @Override
    public boolean shouldRenderOffScreen(SmokerFurnaceBlockEntity_T15 p_112306_) {
        return true;
    }
}
