...
public class SmelterFurnaceBlockEntityRenderer_T15 extends DustFueledMachineBlockEntityRenderer implements BlockEntityRenderer<SmelterFurnaceBlockEntity_T15>
{
    ...
    @Override
    public void render(SmelterFurnaceBlockEntity_T15 p_112307_, float p_112308_, PoseStack p_112309_, MultiBufferSource p_112310_, int p_112311_, int p_112312_) {
            ...
            if(!(stacksList.size() == 0))
            {
                if(facing == Direction.SOUTH) {
                    ...
                    for(int i=0;i<stacksList.size();i++)
                    {
                        ...
                        if(!inputStack.isEmpty())renderItemStacked(p_112307_,world,p_112309_,p_112310_,inputStack,p_112311_,p_112312_, 0.5f, 0.6f, 0.5f, 0.75f, 0.75f, 0.75f,(inputStack.getItem() instanceof BlockItem)?(0.0f):(270.0f), (inputStack.getItem() instanceof BlockItem)?(true):(false));
