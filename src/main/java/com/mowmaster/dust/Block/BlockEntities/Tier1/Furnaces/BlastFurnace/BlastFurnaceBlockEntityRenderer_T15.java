...
public class BlastFurnaceBlockEntityRenderer_T15 implements BlockEntityRenderer<BlastFurnaceBlockEntity_T15>
{
    ...
    @Override
    public boolean shouldRenderOffScreen(BlastFurnaceBlockEntity_T15 p_112306_) {
        return true;
    }
}
