...
public class Tier1BaseBlockEntityRenderer implements BlockEntityRenderer<Tier1BaseBlockEntity>
{
    @Override
    public void render(Tier1BaseBlockEntity p_112307_, float p_112308_, PoseStack p_112309_, MultiBufferSource p_112310_, int p_112311_, int p_112312_) {
    ...
    @Override
    public boolean shouldRenderOffScreen(Tier1BaseBlockEntity p_112306_) {
        return true;
    }
}
