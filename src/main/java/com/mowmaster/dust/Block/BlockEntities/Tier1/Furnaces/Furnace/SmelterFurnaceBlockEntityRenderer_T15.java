...
public class SmelterFurnaceBlockEntityRenderer_T15 implements BlockEntityRenderer<SmelterFurnaceBlockEntity_T15>
{
    ...
    @Override
    public boolean shouldRenderOffScreen(SmelterFurnaceBlockEntity_T15 p_112306_) {
        return true;
    }
}
