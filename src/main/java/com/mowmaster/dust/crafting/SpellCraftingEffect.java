...
public class SpellCraftingEffect
{
    ...
    private SpellCraftingEffect()
    {
        ...
        //this.addSpellCraftingEffectRecipe(65535,new ItemStack(BlockDustStone.ITEM_STONE_033));
        ...
        //this.addSpellCraftingEffectRecipe(11162880,new ItemStack(BlockDustStone.ITEM_STONE_210));
        ...
        //this.addSpellCraftingEffectRecipe(16776960,new ItemStack(BlockDustStone.ITEM_STONE_330));
