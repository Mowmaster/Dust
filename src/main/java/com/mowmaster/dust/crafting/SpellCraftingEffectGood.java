...
public class SpellCraftingEffectGood
{
    ...
    private SpellCraftingEffectGood()
    {
        ...
        this.addSpellCraftingEffectRecipe(16777045,Effects.HERO_OF_THE_VILLAGE);//100
        this.addSpellCraftingEffectRecipe(16777045,Effects.NIGHT_VISION);//101
        ...
        this.addSpellCraftingEffectRecipe(16777045,Effects.INVISIBILITY);//213
        ...
        this.addSpellCraftingEffectRecipe(16777045,Effects.HASTE);//321
