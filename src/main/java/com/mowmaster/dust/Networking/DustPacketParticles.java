...
public class DustPacketParticles
{
    ...
    public DustPacketParticles(EffectType type, double x, double y, double z, int... args) {
        this.type = type;
        this.x = x;
        this.y = y;
        this.z = z;
    ...
    public DustPacketParticles(EffectType type, BlockPos pos, int... args){
        this(type, pos.getX(), pos.getY(), pos.getZ(), args);
    }


    public static DustPacketParticles decode(FriendlyByteBuf buf) {
        ...
        return new DustPacketParticles(type, x, y, z, args);
    }

    public static void encode(DustPacketParticles msg, FriendlyByteBuf buf) {
    ...
    public static class Handler {
        public static void handle(final DustPacketParticles message, final Supplier<NetworkEvent.Context> ctx) {
