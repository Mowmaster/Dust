...
public class ClientItemTooltipComponent  implements ClientTooltipComponent
{
    ...
    private void renderSlot(int p_194027_, int p_194028_, int p_194029_, boolean p_194030_, Font p_194031_, PoseStack p_194032_, ItemRenderer p_194033_, int p_194034_) {
        if (p_194029_ >= this.items.size()) {
            this.blit(p_194032_, p_194027_, p_194028_, p_194034_, p_194030_ ? ClientItemTooltipComponent.Texture.BLOCKED_SLOT : ClientItemTooltipComponent.Texture.SLOT);
        } else {
            ItemStack itemstack = this.items.get(p_194029_);
            this.blit(p_194032_, p_194027_, p_194028_, p_194034_, ClientItemTooltipComponent.Texture.SLOT);
    ...
    private void drawBorder(int p_194020_, int p_194021_, int p_194022_, int p_194023_, PoseStack p_194024_, int p_194025_) {
        this.blit(p_194024_, p_194020_, p_194021_, p_194025_, ClientItemTooltipComponent.Texture.BORDER_CORNER_TOP);
        this.blit(p_194024_, p_194020_ + p_194022_ * 18 + 1, p_194021_, p_194025_, ClientItemTooltipComponent.Texture.BORDER_CORNER_TOP);

        for(int i = 0; i < p_194022_; ++i) {
            this.blit(p_194024_, p_194020_ + 1 + i * 18, p_194021_, p_194025_, ClientItemTooltipComponent.Texture.BORDER_HORIZONTAL_TOP);
            this.blit(p_194024_, p_194020_ + 1 + i * 18, p_194021_ + p_194023_ * 20, p_194025_, ClientItemTooltipComponent.Texture.BORDER_HORIZONTAL_BOTTOM);
        }

        for(int j = 0; j < p_194023_; ++j) {
            this.blit(p_194024_, p_194020_, p_194021_ + j * 20 + 1, p_194025_, ClientItemTooltipComponent.Texture.BORDER_VERTICAL);
            this.blit(p_194024_, p_194020_ + p_194022_ * 18 + 1, p_194021_ + j * 20 + 1, p_194025_, ClientItemTooltipComponent.Texture.BORDER_VERTICAL);
        }

        this.blit(p_194024_, p_194020_, p_194021_ + p_194023_ * 20, p_194025_, ClientItemTooltipComponent.Texture.BORDER_CORNER_BOTTOM);
        this.blit(p_194024_, p_194020_ + p_194022_ * 18 + 1, p_194021_ + p_194023_ * 20, p_194025_, ClientItemTooltipComponent.Texture.BORDER_CORNER_BOTTOM);
    }

    private void blit(PoseStack p_194036_, int p_194037_, int p_194038_, int p_194039_, ClientItemTooltipComponent.Texture p_194040_) {
