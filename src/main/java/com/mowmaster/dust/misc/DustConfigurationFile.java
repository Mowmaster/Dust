...
public class DustConfigurationFile
{
    ...
    public static void SyncConfig()
    {
        ...
        biomeWeightChunks = dustConfig.getInt("5.Crystal Biome Weight", category,180,1,200,"Larger Number is less often");
        ...
        structuresInWorld = dustConfig.getInt("2.Structure Generation", category,2000,1,9999,"Structures in any biome");
