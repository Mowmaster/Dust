...
{
    @ObjectHolder(MODID + ":machinebase")
    public static RecipeSerializer<?> SERIALIZER = new Serializer();

    public static RecipeType<MachineBaseTypeRecipe> MACHINE_BASE = RecipeType.register(MODID + ":machinebase");
    ...
    public static class Serializer extends ForgeRegistryEntry<RecipeSerializer<?>>
            implements RecipeSerializer<MachineBaseTypeRecipe>
    {
